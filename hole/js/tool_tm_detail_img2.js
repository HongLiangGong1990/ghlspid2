...
async function checkErr() {
	...
	while(iframe!=null) {
		...
		const start = await page.waitForSelector('"body > div.sufei-dialog"',500)
		...
		await page.mouse.move(loc2.x+14,loc2.y+10)
		await page.waitFor(467)
		// await page.mouse.down()
		await page.mouse.move(loc2.x+27,loc2.y+3)
		await page.waitFor(367)
		await page.mouse.move(loc.x+33,loc.y+5)
		await page.waitFor(235)
		await page.mouse.move(loc.x+27,loc.y+4)
		await page.waitFor(225)
		await page.mouse.move(loc.x+33,loc.y+7)
		await page.waitFor(245)
		await page.mouse.move(loc.x+47,loc.y+4)
		await page.waitFor(45)
		await page.mouse.move(loc.x+53,loc.y+11)
		await page.waitFor(24)
		await page.mouse.move(loc.x+63,loc.y+17)
		await page.waitFor(45)
		await page.mouse.move(loc.x+83,loc.y+11)
		await page.waitFor(45)
		await page.mouse.move(loc.x+93,loc.y+16)
		await page.waitFor(45)
		await page.mouse.move(loc.x+113,loc.y+16)
		await page.waitFor(45)
		await page.mouse.move(loc.x+123,loc.y+17)
		await page.waitFor(45)
		await page.mouse.move(loc.x+134,loc.y+17)
		await page.waitFor(45)
		await page.mouse.move(loc.x+145,loc.y+19)
		await page.waitFor(45)
		await page.mouse.move(loc.x+156,loc.y+18)
		await page.waitFor(45)
		await page.mouse.move(loc.x+167,loc.y+22)
		await page.waitFor(45)
		await page.mouse.move(loc.x+180,loc.y+21)
		await page.waitFor(45)
		await page.mouse.move(loc.x+200,loc.y+23)



		iframe=document.querySelector("body > div.sufei-dialog");
	}
}
